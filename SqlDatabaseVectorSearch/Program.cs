...
.WithOpenApi(operation =>
{
    ...
    operation.Description = "Uploads a document to SQL Database and saves its embeddings using Vector Support. The document will be indexed and used to answer questions. Currently, only PDF files are supported.";
